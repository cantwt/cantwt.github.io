...
(function () {
    ...
    window.addEventListener("mouseover", function (evt) { if (!touching) generateMouseProxyIfRegistered(evt, "pointerover", true); });
    window.addEventListener("mouseout", function (evt) { if (!touching) generateMouseProxyIfRegistered(evt, "pointerout", true); });
    window.addEventListener("mouseover", function (evt) {
        ...
        if (!foundNode || foundNode === window)
            ...
            dispatchPointerEnter(foundNode, evt.relatedTarget, function (targetNode) {
                generateMouseProxy(evt, "pointerenter", false, targetNode);
            });
        }
    });
    window.addEventListener("mouseout", function (evt) {
        ...
        if (!foundNode || foundNode === window)
            ...
            dispatchPointerLeave(foundNode, evt.relatedTarget, function (targetNode) {
                generateMouseProxy(evt, "pointerleave", false, targetNode);
            });
        }
    });
